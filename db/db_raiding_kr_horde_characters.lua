...
-- All rights reserved.
--
local provider={name=...,data=2,region="kr",faction=2,date="2020-12-09T05:25:34Z",currentRaid={["name"]="Castle Nathria",["shortName"]="CN",["bossCount"]=10},previousRaid=nil,db2={}}
local F
