...
L.ALWAYS_SHOW_EXTENDED_INFO = "Always show full tooltips"
L.ALWAYS_SHOW_EXTENDED_INFO_DESC = "Hold down a modifier (shift/ctrl/alt) to show the full tooltip. If you enable this option, the tooltips will always show the full version."
