...
L.SHOW_MAINS_SCORE = "Show Main's Mythic+ Score and Raid Progress"
...
L.SHOW_BEST_MAINS_SCORE = "Show Main's Score from Best Season"
L.SHOW_BEST_MAINS_SCORE_DESC = "Shows the player's Main's score from either the previous or current season, depending on which has the higher score."
...
L.ENABLE_NO_SCORE_COLORS = "Disable Mythic+ score colors"
...
L.MAINS_SCORE_BEST_SEASON = "Main's Score (%s)"
...
L.CONFIG_WHERE_TO_SHOW_TOOLTIPS = "Where to Show Tooltips"
...
L.SHOW_BEST_RUN = "Show best Mythic+ run from current season as headline"
