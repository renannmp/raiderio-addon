...
L.USE_RAIDERIO_CLIENT_LIVE_TRACKING_SETTINGS = "Allow Raider.IO Client to Control Live Tracking"
...
L.AUTO_COMBATLOG = "Enable Combat Log in Raids & Mythic+ Dungeons"
