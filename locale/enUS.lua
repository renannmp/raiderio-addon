...
L.OUTDATED_GAME_TOOLTIP_MESSAGE = "Score data has expired. Please download the latest Raider.IO Addon."
L.OUTDATED_GAME_TOOLTIP_EXPIRE_IN_DAYS = "Score data is stale. Expires in %d days."
L.OUTDATED_GAME_TOOLTIP_EXPIRE_IN_HOURS = "Score data is stale. Expires in %d hours."
ns.L = L
