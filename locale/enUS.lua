...
L.RAIDERIO_COMBATLOG = "Combat Logging"
L.USE_RAIDERIO_CLIENT_COMBATLOG_SETTINGS = "Use Raider.IO Client Combat Logging settings"
L.USE_RAIDERIO_CLIENT_COMBATLOG_SETTINGS_DESC = "If the Raider.IO Client is present the addon can load its Combat Logging settings."
L.AUTO_COMBATLOG = "Automatically Combat Log instances"
L.AUTO_COMBATLOG_DESC = "Note that the option above will overwrite this option if you use the Raider.IO Client and have disabled combat logging in its settings."
