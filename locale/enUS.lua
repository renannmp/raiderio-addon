...
L.ENABLE_SIMPLE_SCORE_COLORS = "Show Scores in item quality colors"
L.ENABLE_SIMPLE_SCORE_COLORS_DESC = "Shows Scores using item quality colors, less color variants, hopefully helping the the visually impaired to distinguish between the tiers."
