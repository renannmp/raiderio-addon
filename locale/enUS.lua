...
L.SHOW_BEST_MAINS_SCORE = "Show Main's Best Mythic+ Score"
L.SHOW_BEST_MAINS_SCORE_DESC = "to do"
...
L.MAINS_BEST_SCORE_BEST_SEASON = "Main's Best Score (%s)"
L.CURRENT_MAINS_SCORE = "Current Main's Score"
