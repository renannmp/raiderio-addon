...
L.RAIDERIO_BEST_RUN = "Raider.IO M+ Season Best"
...
L.SHOW_RAIDERIO_BESTRUN_FIRST = "Show RaiderIO Best Run primarily"
L.SHOW_RAIDERIO_BESTRUN_FIRST_DESC = "Instead of the score, show primarily the best run of the player."
