...
L.SHOW_SCORE_IN_COMBAT_DESC = "Disable this to minimize performance impact while hovering players during combat."
L.SHOW_KEYSTONE_INFO = "Show Keystone Info"
L.SHOW_KEYSTONE_INFO_DESC = "Adds Keystone information to Keystone tooltips. Predicts score gain for timing the keystone."
